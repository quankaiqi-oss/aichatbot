...
MODELS_DIR = BASE_DIR / "kaiqi_svm" / "models"
SHARED_MODELS_DIR = BASE_DIR / "shared" / "models"
RESULTS_DIR = BASE_DIR / "kaiqi_svm" / "results"
...
def main() -> None:
    ...
    metrics = evaluate_and_save("svm", y_test, predictions, labels, RESULTS_DIR)
    ...
    with open(RESULTS_DIR / "svm_metrics.json", "w", encoding="utf-8") as file:
